...
class ExecutionHandler(BaseExecutionHandler):
    def execute(self, source_data, transformed_data, target_column, subscription_column, discount_id_column, discount_column,
                CustomerID, propensity_lower_limit, propensity_upper_limit, method='Logistic Regression'):
        try:
            transformed_data = transformed_data[transformed_data[subscription_column] == 0]
            data = transformed_data.drop([target_column, CustomerID, discount_id_column, discount_column], axis=1)

import pandas as pd
import numpy as np
from applications.HyperPersonalizationApplication.code.ActionDefinition.customer_summary_plots.python.ExecutionHandler import \
    ExecutionHandler


def test_customer_summary_plots():

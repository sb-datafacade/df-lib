import pandas as pd
from applications.HyperPersonalizationApplication.code.ActionDefinition.merge_demographic_and_physiographic.python.ExecutionHandler import \
    ExecutionHandler


def test_merge_demo_phy_table():

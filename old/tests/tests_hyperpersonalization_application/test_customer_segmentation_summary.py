import pandas as pd
from applications.HyperPersonalizationApplication.code.ActionDefinition.customer_segmentation_summary.python.ExecutionHandler import \
    ExecutionHandler


def test_customer_segmentation_summary():
